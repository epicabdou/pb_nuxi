  ...
  <Teleport to="body">
    ...
    >
      <div
          ...
          `bg-${type}-100 border-l-4 border-${type}-500 text-${type}-800`,
      ...
      >
        <div class="flex items-start">
          ...
          <div class="ml-3">
            <h3 v-if="title" class="text-sm font-medium leading-5">{{ title }}</h3>
            <div class="mt-1">
          ...
          <div class="ml-auto pl-3">
            <div class="-mx-1.5 -my-1.5">
              <button
                  ...
                  :class="`text-${type}-500 hover:bg-${type}-100 focus:ring-${type}-500`"
              >
